...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.ba3f3402b6a4fe4b61e5f7da580e594bdf4de6c65b87e25aef85a0a91f8c3760.js',function(){input.required=false;search();});}
