...
/*!*******************************!*\
  !*** ./src/api/annotation.js ***!
  \*******************************/
/*! exports provided: createAnnotation, updateAnnotation, getAnnotations, getAnnotationsPage, deleteAnnotation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
async function getAnnotationsPage(id, expand = _common__WEBPACK_IMPORTED_MODULE_6__["DEFAULT_EXPAND"], page) {
  const { data } = await _session__WEBPACK_IMPORTED_MODULE_0__["default"].get(Object(_base__WEBPACK_IMPORTED_MODULE_2__["apiUrl"])(Object(_util_url__WEBPACK_IMPORTED_MODULE_4__["queryBuilder"])(`documents/${id}/notes/`, { expand, page_number: page })));
  return data;
}
