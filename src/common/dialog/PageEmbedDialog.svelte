<script>
  ...
  $: embedCode = `<div class="DC-embed" style="font-family: Source Sans Pro, Avenir Next, Avenir, Helvetica Neue, Helvetica, Arial, sans-serif; max-width: 600px; background: rgb(244, 244, 244); padding: 18px 20px; box-sizing: border-box; border: solid 1px gainsboro; border-radius: $radius;">
  ...
  <div style="font-size:14px;line-height:18px;text-align:center">
    Contributed to <a style="color: #5a76a0; text-decoration: underline;" href="${
      process.env.APP_URL
    }" title="Go to DocumentCloud in new window or tab" target="_blank" style="font-weight:700;font-family:Gotham,inherit,sans-serif;color:inherit;text-decoration:none">DocumentCloud</a> by ${
