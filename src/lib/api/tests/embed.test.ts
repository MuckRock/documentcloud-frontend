...
describe("embed tests", () => {
  ...
  test("document embed", () => {
    ...
    const result = `<iframe src="${EMBED_URL}documents/24002098-quarterly-reports-created-pursuant-to-the-letter-from-the-national-archives-and-records-administration-dated-june-1-2018/?embed=1" width="612" height="792" style="border: 1px solid #d8dee2; border-radius: 0.5rem; width: 100%; height: 100%; aspect-ratio: 612 / 792" allow="fullscreen"></iframe>`;
...
<script src="${EMBED_URL}embed/resize.js"></script>`;
